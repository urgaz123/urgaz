...
const updateProduct = async (req, res) => {
  try {
    ...
    if (product) {
      ...
      product.sachoq = req.body.sachoq;
      product.material = req.body.material;
      product.designType = req.body.designType;
      product.lanset = req.body.lanset;
      product.point = req.body.point;
      product.tail = req.body.tail;
      product.comb = req.body.comb;
      await product.save();
